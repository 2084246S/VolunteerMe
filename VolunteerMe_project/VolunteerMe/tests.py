...
class OpportunityTestCase(TestCase):
    def setUp(self):
        ...
        opportunity = Opportunity.objects.create(name = "Admin", category = "Administrative / Office Work",company = userprofile,
                                                 start_date=date.today(), end_date=date.today(),
                                                 description = "Helping with the finances for a community center",
                                                 location = "4 Privet Drive, Surrey", optional = "must be good with children")
